...
const UTBKStudentApp = () => {
  ...
  useEffect(() => {
    const handleViolation = (reason) => {
        // 🔥 UPDATE: Cek screenRef. Jika di result atau landing, fungsi ini MATI.
    ...
    const handleKeyDown = (e) => {
      // 🔥 UPDATE: JIKA DI HALAMAN RESULT / LANDING, BOLEH TEKAN APA SAJA
      if (screenRef.current === 'result' || screenRef.current === 'landing') return;
    ...
    const handleContextMenu = (e) => {
        // 🔥 UPDATE: JIKA DI HALAMAN RESULT / LANDING, BOLEH KLIK KANAN
        if (screenRef.current === 'result' || screenRef.current === 'landing') return;
        e.preventDefault();
    }
